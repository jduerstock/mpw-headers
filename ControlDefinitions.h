...
enum {
  kControlEditTextCFStringTag   = FOUR_CHAR_CODE('cfst') /* CFStringRef*/
};
...
enum {
  kControlStaticTextCFStringTag = FOUR_CHAR_CODE('cfst') /* CFStringRef*/
};
...
enum {
  ...
  kControlRoundButtonSizeTag    = FOUR_CHAR_CODE('size') /* ControlRoundButtonSize*/
};
