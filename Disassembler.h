/*---------------------------------------------------------------------------*
 ...
 |                                  5/9/93                                   |
 |                                                                           |
 |                  Copyright Apple Computer, Inc. 1993-1999                 |
 |                           All rights reserved.                            |
 |                                                                           |
 *---------------------------------------------------------------------------*/
...
#if 0
#define DisHdrVersion "3.2"                /* Current version nbr.rev of this header		*/
#endif
...
#define Disassemble_Vec				 0x00000010UL	/*                AltiVec										*/
#define Disassemble_AltiVec		 0x00000012UL	/*                AltiVec + 32-bitPowerPC		*/
...
/* defines the possible substitutable objects:																					*/
...
typedef enum {															/* Types of substitutable objects:					*/
	...
	Disassembler_Lookup_VecRegister						/*			AltiVec vector register							*/
...
union DisLookupValue {											/* A "meaningful" name for each value type:	*/
	...
	unsigned long vr;													/*		Disassembler_Lookup_VecRegister				*/
...
/* where, refCon 				 = A "reference constant" that can be used as a communication link
					...
					thingToReplace = The kind of object and the associated value of that object to be
				                   ...
				                   Disassembler_Lookup_AbsAddress		address [1]
													 ...
													 Disassembler_Lookup_VecRegister  0:31    [5]
													 =============================================

	 												 Notes: 
													 
													 [1] This is an absolute target branch address, i.e., the "a"
													     bit in the branch instruction IS set. The passed absAddress
													 ...
													 [2] This is a relocatable target branch address, i.e., the "a"
															 ...
															 where cia is the current instruction address, i.e., the
															 value of the instruction address passed to the
															 disassembler.
													 ...
													 [4] The lookup for SPRs is slightly different in that it is
													 		 only done as an ESCAPE mechanism, i.e., only when the SPR
															 number is NOT one of the predefined Power, 601, PowerPC32,
															 PowerPC64, or AltiVec SPR names.  This is done because the
															 different PowerPC architectures can have additional SPRs
															 specific to those architectures!  The lookup routine is
															 called only if the SPR is NOT one of the following
															 predefined numbers:
																	
																0 MQ      272 SPRG0  528 IBAT0U   928 UMMCR2   1008 HID0
																1 XER     273 SPRG1  529 IBAT0L   935 UBAMR    1009 HID1
																4 RTCU    274 SPRG2  530 IBAT1U   936 UMMCR0   1010 IABR
																5 RTCL    275 SPRG3  531 IBAT1L   937 UPMC1    1013 DABR
																6 DEC     280 ASR    532 IBAT2U   938 UPMC2    1014 MSSCR0
																8 LR      284 TBL    533 IBAT2L   939 USIA     1015 MSSCR1
																9 CTR     285 TBU    534 IBAT3U   940 UMMCR1   1017 L2CR
															 18 DSIAR   287 PVR    535 IBAT3L   941 UPMC3    1019 ICTC
															 19 DAR                             942 UPMC4    1020 THRM1
															 22 DEC                536 DBAT0U   944 MMCR2    1021 THRM2
															 25 SDR1               537 DBAT0L   951 BAMR     1022 THRM3
															 26 SRR0               538 DBAT1U   952 MMCR0    1023 PIR
															 27 SRR1               539 DBAT1L   953 PMC1
															                       540 DBAT2U   954 PMC2
															 					             541 DBAT2L   955 SIA
															 					             542 DBAT3U   956 MMCR1
															 					             543 DBAT3L   957 PMC3
															 					                          958 PMC4
															 				                            959 SDA
															 				                            976 DMISS
															 ...
															 accepted but returns a status warning, or the instruction
															 is treated as invalid (“DC.L 0xXXXXXXXX”).
													 ...
													 [5] The AltiVec vector registers are only used if the
													 		 Disassemble_Vec or Disassemble_AltiVec was passed in the
															 options.																									*/
...
DisassemblerStatus ppcDisassembler(unsigned long  		 *instruction, 
	...
	#define Disassembler_Vec					0x0200U	/* AltiVec vector instruction								*/
	...
	Disassembler_InvRsvBits		- The instruction had some or all of its reserved bits
															...
															NOT set.  This is something like a "warning".  With the
															option set, this condition is considered as an "error" and
															the "invalid instruction" is generated ("dc.l 0xXXXXXXXX").
	...
	Disassembler_Vec					-	The instruction is a AltiVec vector instruction.
