/*
	...
	Version:	MPW 3.4a3 for E.T.O. #18
	Created:	Monday, June 19, 1995
...
#error "The SANE.h header can only be used for code using the Classic 68K runtime model."
...
/* typedef struct {short w[6];} extended96;	-- Now defined in Types.h */
